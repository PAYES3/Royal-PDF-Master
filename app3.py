...
# --- 🚀 MOBILE ADS INJECTION (Direct & Clean) ---
def inject_mobile_ads():
    # PC-la block aagaama mobile-la ads trigger panna indha script dhaan best
    social_bar_script = """
...
# --- 🖼️ FULL PDF PREVIEW LOGIC (Restored 140+ lines logic) ---
...
if app_mode == "👑 Premium Plan":
    ...
    st.info("Mobile users: Upgrade for ₹99 to enjoy an ad-free experience.")
    st.markdown(f'''
        <a href="{upi_url}" target="_blank" style="text-decoration: none;">
